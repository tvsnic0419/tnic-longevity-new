...
**Primary hallmarks targeted:** [Chronic inflammation](/library/chronic-inflammation) · [Genomic instability](/library/genomic-instability) · [Mitochondrial dysfunction](/library/mitochondrial-dysfunction) · [Altered intercellular communication](/library/altered-intercellular-communication)
...
These four mechanisms are well-characterized polyphenol pharmacology, consistent with how other OPC-rich compounds (resveratrol, pterostilbene) are understood to act. What's genuinely uncertain is not the mechanism but the clinical magnitude — see Section 3.
