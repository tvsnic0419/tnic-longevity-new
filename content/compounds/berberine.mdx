...
**Primary hallmarks targeted:** [Deregulated nutrient sensing](/library/disabled-macroautophagy) · [Chronic inflammation](/library/chronic-inflammation) · [Mitochondrial dysfunction](/library/mitochondrial-dysfunction) · [Altered intercellular communication](/library/altered-intercellular-communication)

:::evidence tier="A"
Yin et al. 2008 (PMID 18396172, *Metabolism*): a head-to-head RCT randomized 116 type 2 diabetes patients to berberine 500 mg TID vs metformin 500 mg TID for 13 weeks. Berberine reduced fasting glucose 20% and HbA1c by 2.0 percentage points — outcomes statistically equivalent to metformin. A meta-analysis of 27 RCTs (PMID 26507383, *Phytomedicine* 2015) confirms consistent lipid and glucose improvements across trials. Tier A applies specifically to glycemic and lipid metabolic markers; general longevity benefit beyond those markers remains Tier B (mechanistic).
:::
...
| --- | --- | --- |
| Resveratrol | Berberine's AMPK activation supplies the energy-deficit signal that primes SIRT1 for resveratrol to engage | [AMPK/SIRT1 Crosstalk Pair](/library/synergies/berberine-resveratrol-ampk-sirt1) |
...
:::cta href="/library/compare/glp1-vs-berberine" title="See the GLP-1 comparison" label="GLP-1/GIP Agonists vs Berberine"
Never tested head-to-head — see what each one's own trial evidence actually shows before assuming equivalence.
:::
