...
:::warning title="Where berberine disappoints"
- **GI tolerance is the real dose limiter.** Cramping and diarrhea at 500 mg TID are common enough that many people can't sustain the trial dose — and under-dosing forfeits the effect.
- **Poor bioavailability.** Standard berberine HCl is absorbed inefficiently; without a dihydroberberine form or split dosing with meals, plasma levels stay low.
- **The metabolic effect is largest in people who are metabolically unwell.** If your glucose and lipids are already good, expect a smaller signal — the headline trials were in type-2 diabetics, not healthy longevity seekers.
:::
...
:::warning title="Who should skip berberine"
- **Anyone on metformin or another glucose-lowering drug** — overlapping mechanism plus additive hypoglycemia risk.
- **Anyone taking a CYP3A4-metabolized medication** — berberine is a potent CYP3A4/P-gp inhibitor and can raise those drug levels.
- **Pregnant or nursing** — it may cross the placenta and has been linked to kernicterus risk in infants.
:::
