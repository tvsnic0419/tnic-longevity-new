...
> **TL;DR** — Ca-AKG is a TCA cycle intermediate that doubles as a cofactor for the epigenetic enzymes (TETs, JMJDs) that reverse age-related DNA methylation drift. Mouse data shows ~12% median lifespan extension; the human ABLE trial is registered but has not yet reported results. Take 1 g AM with breakfast; no pairing restrictions. Highest hallmark breadth per gram of any OTC compound on the TNiC panel.
...
:::evidence tier="A"
Shahmirzadi et al. *Cell Metabolism* 2020 (PMID 32877690): Ca-AKG supplementation extended median lifespan by 12% in female C57BL/6J mice and reduced age-related frailty. No published human trial has yet confirmed these effects in people — the human ABLE trial is registered but results are not yet reported, so do not assume the mouse lifespan finding translates to a specific human benefit.
:::
...
| ABLE trial (registered) | Human RCT, not yet reported | Middle-aged/older adults | Results not yet published | — |
...
**Consensus:** Tier A for preclinical lifespan extension (mouse data is clean and replicated). No published human trial has yet confirmed these effects in people — the ABLE trial is registered but unreported. AKG's role as a TET/JMJ cofactor is mechanistically established and independent of any single trial. No completed RCT in healthy humans for longevity endpoints.
...
| hs-CRP | <1.0 mg/L | 3–6 months | Mouse data supports an anti-inflammatory mechanism; human confirmation pending (ABLE trial) |
...
:::compare title="12-week Ca-AKG response (mechanism-informed, human data pending)" before="Pre-supplementation" after="12-week target (proxy markers only)" summary="Mouse data shows lifespan extension; human epigenetic and inflammatory endpoints are proxies pending the ABLE trial, not confirmed human effects."
