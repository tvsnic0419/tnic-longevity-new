...
Metformin is a prescription medication. This module documents the evidence for informed physician discussions — we do not prescribe, source, or recommend self-medication. It is deliberately **not** a native Stack Architect compound. See [/trust/disclaimers](/trust/disclaimers).
:::
...
The figures below reflect published clinical and trial protocols — **not** a recommendation to self-start. Metformin requires a prescription and renal-function monitoring.
:::
...
## 7. Synergies (educational — mechanism overlap, not a stack recommendation)

| Intervention | Relationship to metformin |
| --- | --- |
| [Berberine](/library/compounds/berberine) | Near-identical Complex-I → AMPK mechanism — **redundant**, and additive hypoglycemia risk; do not combine casually |
