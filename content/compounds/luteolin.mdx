...
| --- | --- |
| [apigenin](/library/compounds/apigenin) | Near-identical flavone (apigenin is luteolin without one hydroxyl); overlapping NF-κB/CD38 anti-inflammatory action — treat as redundant rather than additive. |
