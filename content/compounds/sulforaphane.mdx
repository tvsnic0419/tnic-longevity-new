...
Sulforaphane does not donate electrons like vitamin C — it **changes gene expression**. That is why pairing with **GlyNAC substrate** (GSH precursors) outperforms either alone in the NRF2 architecture.
