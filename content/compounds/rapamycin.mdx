...
Rapamycin is an immunosuppressant at transplant doses. This module documents evidence for informed physician discussions — we do not prescribe, source, or recommend self-medication. Research-chemical sirolimus is never acceptable. See [/trust/disclaimers](/trust/disclaimers).
:::
...
The following reflects published discussion protocols — **NOT** recommendations from this site. Individual dosing requires medical oversight.
:::
...
**Supporting OTC stack (educational combo):** GlyNAC + NMN + Ca-AKG addresses complementary hallmarks while physician manages rapamycin.
...
Log CBC and metabolic markers alongside physician orders — This does not replace clinical monitoring.
:::
