...
| --- | --- | --- |
| CoQ10 (Ubiquinone) | Classic mitochondrial pairing — PQQ proposed to build mitochondria, CoQ10 supports electron transport within them; evaluate as complementary, not proven-additive | [CoQ10 module](/library/compounds/coq10) |
...
- No dedicated human stack-interaction data exist for PQQ combined with other TNiC compounds — treat these pairings as mechanistically reasonable, not clinically demonstrated.
