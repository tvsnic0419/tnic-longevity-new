...
- No dedicated human stack-interaction data exist for PQQ combined with other compounds in this library — treat these pairings as mechanistically reasonable, not clinically demonstrated.
