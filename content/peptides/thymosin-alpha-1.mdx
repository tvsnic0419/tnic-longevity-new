...
- Immune-modulating peptides are not inherently safe to self-direct in the presence of autoimmune disease — the same mechanism that helps immune response in hepatitis could theoretically worsen autoimmune flare-ups.
...
- No characterized interaction profile exists for combining with other immunomodulators or supplements at longevity-community doses.
