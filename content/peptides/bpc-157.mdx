...
If you choose to track subjective recovery markers independently of any recommendation here, a simple log separates signal from noise better than memory does.
