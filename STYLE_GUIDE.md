...
## 23. Instruments: population, viewport, and the reveal floor

Three rules that each came from a measured defect, not a preference.

### 23.1 Every count names its population, visibly
...
### 23.2 Atmosphere is desktop-optional; data is not
...
### 23.3 Scroll-scrubbed reveals hold an opacity floor of 0.78
