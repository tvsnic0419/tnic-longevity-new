          ...
          <div className="grid items-center gap-10 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5">
              <GuideHeroPanel
                ...
                stats={[
                  { value: '−0.9%', label: 'HbA1c reduction', colorClass: 'text-accent-emerald' },
                  { value: '≈Metformin', label: 'Effect size vs drug', colorClass: 'text-accent-violet' },
                  { value: '1.5 g/day', label: 'Evidence dose', colorClass: 'text-accent-cyan' },
                  { value: 'Tier A', label: 'Metabolic evidence', colorClass: 'text-accent-rose' },
                ]}
              />
            </div>
          </div>
            ...
            {FAQ.map((faq) => (
              <details key={faq.q} className="group rounded-xl border border-border/60 bg-card/50">
                ...
                <div className="px-5 pb-5 text-sm text-muted-foreground leading-relaxed border-t border-border/40 pt-4">
                  <LinkedText text={faq.a} excludeNames={['Berberine']} />
                </div>
              </details>
            ))}
          </div>
