...
const EVIDENCE_TABLE = [
  {
    ...
    finding:
      'A human dose-escalation safety trial (Riche 2013) evaluated pterostilbene up to 250mg/day over 6–8 weeks and established a favorable human safety and tolerability profile. This is a safety trial, not an efficacy trial — it did not test or confirm cognitive, longevity, or other benefit endpoints.',
  ...
  },
  {
    ...
    finding:
      'No verified human efficacy or outcome RCT exists for pterostilbene in this guide. The Riche 2013 trial establishes safety only — do not interpret it as evidence of cognitive, metabolic, or longevity benefit.',
  ...
  },
  {
    ...
    finding:
      "Pterostilbene's two methoxy groups (versus resveratrol's two hydroxyl groups) substantially reduce intestinal glucuronidation, the primary bottleneck limiting resveratrol's oral bioavailability. This is a preclinical/mechanistic pharmacokinetic finding, not a head-to-head human bioavailability RCT.",
  ...
  },
  {
    ...
    finding:
      'Pterostilbene\'s added lipophilicity extends plasma half-life to roughly 105 minutes, compared with roughly 14 minutes for resveratrol — a pharmacokinetic advantage established in preclinical models.',
    quality: 'Preclinical / mechanistic',
    pmid: undefined,
    color: 'text-accent-cyan',
    badge: 'bg-accent-cyan/10 border-accent-cyan/20',
  },
  {
    ...
    finding:
      'Mechanistically similar to resveratrol: allosteric SIRT1 activation and AMPK agonism via CAMKK2 signaling. This is well-established mechanistic pharmacology carried over from the broader stilbenoid literature, not a pterostilbene-specific human outcome trial.',
  ...
  },
  {
    ...
    finding: 'No human longevity-endpoint trial exists for pterostilbene as of 2026. The evidence base here is a human safety trial plus preclinical mechanistic data — not a proven longevity outcome.',
    quality: 'Not established',
    pmid: undefined,
    color: 'text-amber-400',
    badge: 'bg-amber-400/10 border-amber-400/20',
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Yes — pterostilbene uniquely activates PPARα (peroxisome proliferator-activated receptor alpha) in addition to the SIRT1/AMPK mechanisms it shares with resveratrol. PPARα activation supports lipid oxidation and ketogenesis-adjacent metabolism, a mechanistic feature resveratrol lacks. This is established mechanistic pharmacology, not a human-outcome trial finding specific to pterostilbene.',
  },
  {
      ...
      <section className="py-16 md:py-20 border-b border-border">
        <div className="container-page max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-6 max-w-2xl">
            Pterostilbene is resveratrol&rsquo;s methylated cousin — with a real human safety trial behind it and a mechanistic bioavailability edge. Here is exactly what that trial showed, what it didn&rsquo;t, and how to dose it correctly.
          </p>
        ...
        <div className="container-page max-w-4xl">
          ...
          <div className="rounded-xl border border-amber-400/20 bg-amber-400/[0.04] p-5">
            ...
            <p className="text-sm text-muted-foreground">
              The bioavailability upgrade is real and mechanistically well-supported — you need less pterostilbene to reach comparable plasma exposure, and it comes with an actual human safety trial rather than relying entirely on animal data. What it doesn&rsquo;t have is resveratrol&rsquo;s decades-deep research base or a human efficacy trial of its own. If absorption and tolerability are your priority, pterostilbene is a reasonable upgrade to evaluate. Read the full <Link href="/resveratrol-supplement-guide" className="text-accent-violet hover:underline">resveratrol guide</Link> and the <Link href="/library/compare/resveratrol-vs-pterostilbene" className="text-accent-violet hover:underline">head-to-head comparison</Link> before deciding.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 border-b border-border">
        <div className="container-page max-w-4xl">
          ...
          <p className="text-body mb-8 max-w-2xl">
            A conservative ramp based on the commonly used 50–150mg range, staying well within the 250mg/day ceiling evaluated in the human safety trial.
          </p>
            ...
            {[
              {
                ...
                body: "Pterostilbene carries two methoxy groups where resveratrol has two hydroxyl groups. This structural difference dramatically reduces glucuronidation in the intestinal wall — the primary reason resveratrol has poor oral bioavailability — while also increasing lipophilicity for better cellular membrane penetration.",
              },
              {
                icon: Zap,
                color: 'text-accent-violet',
                ...
                body: 'Mechanistically similar to resveratrol: allosteric SIRT1 activation and AMPK agonism via CAMKK2 signaling. Because more of an oral dose survives first-pass metabolism, pterostilbene reaches several-fold higher plasma concentrations per equivalent milligram dose.',
              },
              {
                icon: TrendingUp,
                color: 'text-accent-emerald',
                ...
                body: 'Beyond the SIRT1/AMPK mechanisms it shares with resveratrol, pterostilbene also activates PPARα (peroxisome proliferator-activated receptor alpha), adding a lipid-oxidation and ketogenesis-supporting effect that resveratrol lacks.',
              },
            ].map((card) => (
            ...
            {[
              {
                ...
                body: 'Shared SIRT1/AMPK activation supports mitochondrial biogenesis and metabolic efficiency through the same PGC-1α-linked pathway resveratrol uses, plus PPARα activation adding a direct lipid-oxidation route that supports mitochondrial fuel utilization.',
              ...
              },
              {
                ...
                body: 'NF-κB suppression via the shared SIRT1 mechanism provides the same mechanistic rationale for dampening chronic low-grade inflammation that resveratrol carries — again, a mechanistic pathway rather than a pterostilbene-specific human-outcome finding.',
            ...
            {[
              {
                ...
                body: 'The Riche 2013 dose-escalation trial (PMID 23431291) established safety up to 250mg/day over 6–8 weeks. It did not measure cognitive, metabolic, or longevity outcomes — treat any benefit claim as preclinical or mechanistic reasoning, not proven by that trial.',
              },
              {
                n: '02',
                title: 'Check bleeding risk, statins, and glucose medications',
                body: 'Pterostilbene may lower LDL and blood glucose at higher doses and carries a theoretical antiplatelet effect. Talk to your physician first if you take statins, glucose-lowering medications, or blood thinners.',
              },
              {
                n: '03',
                title: 'Start at 50mg in the evening with food',
                body: 'Take your first dose with dinner. Evening dosing mirrors the same circadian SIRT1-expression rationale used for resveratrol.',
              },
              {
                n: '04',
                title: 'Titrate to 100–150mg if well tolerated',
                body: 'After one to two weeks without side effects, move toward the middle of the 50–150mg range — well within the 250mg/day ceiling the human safety trial evaluated.',
              },
              {
                n: '05',
                title: 'Track your own biomarkers rather than assuming a benefit',
                body: "Because the only verified human trial for pterostilbene is a safety trial, your own lipid panel, fasting glucose, and subjective response over 8–12 weeks are your best evidence of individual effect. Don't rely on marketing claims that imply proven efficacy.",
              },
            ].map((step) => (
          ...
          <div className="rounded-2xl border border-accent-rose/20 bg-accent-rose/[0.04] p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Pterostilbene may lower LDL cholesterol and blood glucose at higher doses. If you take statins or glucose-lowering medications, monitor labs and inform your physician before starting. It also carries a theoretical antiplatelet effect — stop at least two weeks before any scheduled surgery. TNiC content is educational and not a substitute for medical advice.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-page max-w-4xl">
          <div className="rounded-2xl border border-accent-cyan/20 bg-accent-cyan/[0.04] p-8 md:p-10 text-center">
            ...
            <p className="text-body text-muted-foreground mb-8 max-w-xl mx-auto">
              Pterostilbene pairs with NMN in TNiC&rsquo;s SIRT1-focused presets as a higher-bioavailability alternative to resveratrol. Take the quiz to get a personalized protocol.
            </p>
