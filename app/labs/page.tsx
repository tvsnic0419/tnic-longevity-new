    ...
    <>
      ...
      <PageShell>
        ...
        <section aria-labelledby="labs-graph-heading" className="mt-14">
          <div className="premium-card hub-panel instrument-module p-5 md:p-7">
            ...
            <div className="premium-card-grid grid gap-5 sm:grid-cols-2 lg:grid-cols-3" data-symmetric-grid>
