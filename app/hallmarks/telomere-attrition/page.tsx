      ...
      <main id="main-content" tabIndex={-1}>
        <section className="pt-28 pb-16 md:pt-36 md:pb-20 relative overflow-hidden">
          ...
          <div className="relative container-page max-w-6xl">
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground mb-4">
              ...
              <span>/</span>
              <span className="text-accent-violet">Telomere Attrition</span>
            </div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent-violet/10 border border-accent-violet/20 mb-6">
              <Timer className="w-3.5 h-3.5 text-accent-violet" />
              <span className="text-xs font-medium text-accent-violet tracking-widest uppercase">Hallmark #2 of 12</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-black tracking-tight text-foreground mb-6 leading-[1.05]">
              Telomere<br /><span className="text-accent-violet">Attrition</span>
            </h1>
        ...
        <section className="py-20 border-t border-border/50">
          <div className="container-page max-w-4xl">
            <p className="text-xs text-accent-violet uppercase tracking-widest font-medium mb-4">The Mechanism</p>
        ...
        <section className="py-20 border-t border-border/50 bg-card/10">
          <div className="container-page max-w-4xl">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-xs text-accent-violet uppercase tracking-widest font-medium">Monitoring</p>
            </div>
        ...
        <section className="py-20 border-t border-border/50">
          <div className="container-page text-center max-w-2xl">
            <ShieldCheck className="w-10 h-10 text-accent-violet mx-auto mb-5" />
