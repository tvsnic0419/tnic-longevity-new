...
import { Activity, ArrowRight, FlaskConical, ShieldCheck, BookOpen, Layers, Pill, Library } from 'lucide-react';
...
export default function DisabledAutophagyPage() {
  const compoundsForHallmark = getCompoundsForHallmark('autophagy');
        ...
        <section className="py-20 border-t border-border/50">
          <div className="container-page max-w-4xl">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-xs text-emerald-400 uppercase tracking-widest font-medium">Compound Library</p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
              {compoundsForHallmark.map((compound) => (
                <Link
                  ...
                  className="flex items-center justify-between gap-3 rounded-2xl border border-border/60 bg-card/40 p-4 hover:border-emerald-500/40 transition-colors"
                >
        ...
        <section className="py-20 border-t border-border/50">
          <div className="container-page text-center max-w-2xl">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <Link href="/library/disabled-autophagy" className="inline-flex items-center gap-2 border border-border px-6 py-3 rounded-xl text-sm font-medium text-muted-foreground hover:text-foreground transition-colors"><Library className="w-4 h-4" />View in Library</Link>
            </div>
          </div>
        </section>
      </main>
