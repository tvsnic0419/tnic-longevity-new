      ...
      <main id="main-content" tabIndex={-1}>
        ...
        <section className="py-20 border-t border-border/50">
          <div className="container-page max-w-4xl">
            ...
            <h2 className="heading-section text-foreground mb-6">The growth-vs-cleanup switch — and why it gets stuck</h2>
        ...
        <section className="py-20 border-t border-border/50 bg-card/10">
          <div className="container-page max-w-4xl">
            ...
            <h2 className="heading-section text-foreground mb-6">Nutrient sensing biomarkers</h2>
        ...
        <section className="py-20 border-t border-border/50">
          <div className="container-page max-w-4xl">
            ...
            <h2 className="heading-section text-foreground mb-2">mTOR suppression — from lifestyle to clinical</h2>
        ...
        <section className="py-20 border-t border-border/50">
          <div className="container-page text-center max-w-2xl">
            ...
            <h2 className="heading-section text-foreground mb-4">Flip the switch back to cleanup mode.</h2>
