...
import { Activity, ArrowRight, FlaskConical, ShieldCheck, BookOpen, Scale, Sparkles } from 'lucide-react';
        ...
        <section className="pt-28 pb-16 md:pt-36 md:pb-20 relative overflow-hidden">
          ...
          <div className="relative container-page max-w-4xl">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/library/disabled-macroautophagy" className="inline-flex items-center gap-2 border border-border px-5 py-3 rounded-xl text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
