      ...
      <main id="main-content" tabIndex={-1}>
        ...
        <section className="py-20 border-t border-border/50">
          <div className="container-page max-w-4xl">
            ...
            <p className="text-muted-foreground mb-8">Structured compound profiles — dosing, mechanism, and evidence tier — for library compounds tagged as targeting stem cell exhaustion.</p>
        ...
        <section className="py-20 border-t border-border/50">
          <div className="container-page text-center max-w-2xl">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <Link href="/library/stem-cell-exhaustion" className="inline-flex items-center gap-2 border border-border px-6 py-3 rounded-xl text-sm font-medium text-muted-foreground hover:text-foreground transition-colors"><Library className="w-4 h-4" />View in Library</Link>
            </div>
          </div>
        </section>
      </main>
