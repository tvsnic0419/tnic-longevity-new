        ...
        <section className="pt-28 pb-16 md:pt-36 md:pb-20 relative overflow-hidden">
          ...
          <div className="relative container-page max-w-6xl">
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground mb-4">
              ...
              <span>/</span>
              <span className="text-accent-rose">Chronic Inflammation</span>
            </div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent-rose/10 border border-accent-rose/20 mb-6">
              <Shield className="w-3.5 h-3.5 text-accent-rose" />
              <span className="text-xs font-medium text-accent-rose tracking-widest uppercase">Hallmark #10 of 12</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-black tracking-tight text-foreground mb-6 leading-[1.05]">
              Chronic<br /><span className="text-accent-rose">Inflammation</span>
            </h1>
        ...
        <section className="py-20 border-t border-border/50 bg-card/10">
          <div className="container-page max-w-4xl">
            ...
            <p className="text-xs text-muted-foreground mt-4">
              Log hs-CRP, IL-6, and homocysteine in the <Link href="/labs" className="text-accent-rose hover:underline">Lab Tracker</Link> to monitor trend over time.
            </p>
          </div>
        </section>
