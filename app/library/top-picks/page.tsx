...
export const metadata: Metadata = {
  ...
  description:
    'The highest-conviction compound picks for three overlapping longevity pathways: sirtuin (SIRT1-7) activation, PARP-mediated DNA repair, and NRF2 antioxidant signaling — with the mechanistic reason each pick made the list.',
  openGraph: {
