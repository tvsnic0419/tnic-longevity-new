...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: `${deltaLine}${p.coverage}% of the 12 hallmarks of aging covered with a ${p.stackSize}-compound stack. Build yours free — no account, evidence-graded.`,
      ...
      <div className="container-page py-16 md:py-24 max-w-3xl">
        ...
        <div className="card-floating rounded-2xl p-8 text-center">
          ...
          <p className="text-body-sm max-w-md mx-auto mb-6">
            ...
            {COMPOUND_COUNT} evidence-graded compounds, 12 hallmarks of aging, every claim PubMed-cited.
          </p>
