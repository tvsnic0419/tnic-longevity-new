...
// small-size legibility, more character, so the text plane no longer reads as
// a default SaaS stack. Self-hosted via next/font (no layout-shift, no
// external @import), exposed as CSS variables.
