    ...
    <nav className="fixed top-0 w-full z-50" aria-label="Main navigation">
      ...
      >
        ...
        <div ref={logoRef} className="flex items-center gap-2.5 shrink-0">
          ...
          <span
            aria-hidden="true"
            className="hidden xl:block border-l border-border/60 pl-2.5 font-mono text-[length:var(--type-micro)] font-semibold uppercase leading-[1.25] tracking-[0.1em] text-muted-foreground"
          >
            Cell-Health
            <br />
            Library
