...
export function DefenseCalculator() {
  ...
  return (
    <SectionShell
      ...
      subtitle="TNiC estimates directional biological-age pressure from lifestyle inputs, then shows which pathways may deserve closer review. It is educational modeling, not a diagnostic clock or prescription."
