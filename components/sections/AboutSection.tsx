...
const pillars = [
  ...
  },
  {
    ...
    desc: 'Compounds earn Tier A, B, or C ratings based on evidence strength — human trial data, emerging human signals, or preclinical-only status are separated clearly.',
  },
  {
    icon: Heart,
