          ...
          <div className="chero-stage">
            ...
            <div className="chero-hint">
              ...
              {/* The hint used to read "drag · scroll to zoom" on every device.
                  ...
                  hydration mismatch. */}
              <span className="chero-hint__fine">
                {structured ? "drag · scroll to zoom" : "orbital field · illustrative"}
              </span>
              <span className="chero-hint__coarse">
...
.chero-hint__coarse { display: none; }
@media (hover: none), (pointer: coarse) {
  .chero-hint__fine { display: none; }
  .chero-hint__coarse { display: inline; }
}
