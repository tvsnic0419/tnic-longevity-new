...
.tnic-hero-badges .pill {
  ...
  font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 11px;
...
.tnic-molcard .formula { font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 14px; color: var(--cyan); letter-spacing: .08em; }
...
.tnic-molcard .fact .k { font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 10.5px; letter-spacing: .18em; text-transform: uppercase; color: var(--faint); }
...
.tnic-molcard .cite { font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 10.5px; color: var(--faint); letter-spacing: .1em; }
...
.tnic-descent .node-label {
  font-family: var(--font-inter, 'Inter', sans-serif); font-size: 14px; font-weight: 500;
...
.tnic-search {
  ...
  padding: 10px 14px; border-radius: 10px; font-family: var(--font-inter, 'Inter', sans-serif); font-size: 14px;
  outline: none;
}
...
.tnic-chip {
  ...
  border-radius: 999px; font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 10.5px;
...
.tnic-readout .r-eyebrow { font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 11px; letter-spacing: .2em; text-transform: uppercase; color: var(--faint); display: flex; align-items: center; gap: 8px; }
...
.tnic-readout .r-meta { display: flex; gap: 12px; margin-bottom: 12px; font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 10.5px; letter-spacing: .1em; color: var(--faint); text-transform: uppercase; }
...
.tnic-readout .r-link .r-tag { font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 10px; letter-spacing: .12em; text-transform: uppercase; margin-left: 8px; }
.tnic-readout .r-link .r-why { font-size: 12.5px; color: var(--muted); line-height: 1.5; margin-top: 3px; }
.tnic-readout .r-cta {
  display: inline-flex; align-items: center; gap: 8px; margin-top: 16px;
  color: var(--cyan); text-decoration: none; font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace);
...
.tnic-legend .lg { display: flex; align-items: center; gap: 8px; font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 10.5px; letter-spacing: .1em; color: var(--muted); text-transform: uppercase; }
...
.tnic-age small { font-size: .32em; color: var(--muted); font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); letter-spacing: .12em; margin-left: 8px; }
...
.tnic-tl-stat .k { font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 10.5px; letter-spacing: .16em; text-transform: uppercase; color: var(--faint); }
...
.tnic-final-elites .head {
  font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 11px; letter-spacing: .2em;
...
.tnic-elite-card .tier {
  font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 10px; letter-spacing: .18em;
...
.tnic-rail .lbl { font-family: var(--font-jetbrains-mono, 'JetBrains Mono', monospace); font-size: 10.5px; letter-spacing: .16em; text-transform: uppercase; opacity: 0; transform: translateX(6px); transition: all .3s ease; }
