...
export function QuizShareRedirect({ preset }: { preset: PresetKey }) {
  ...
  return (
    <div className="container-page py-24 text-center">
      <p className="text-label text-accent-emerald mb-2">Nico result</p>
      <h1 className="heading-section text-2xl mb-2">{stack.label} Stack</h1>
      <p className="text-body-sm text-muted-foreground">Opening your personalized Nico Questionnaire result…</p>
    </div>
  );
}