...
export const libraryModules: LibraryModule[] = [
  ...
  },
  {
    ...
    tagline: 'Silkworm proteolytic enzyme — real but modest post-surgical evidence; marketed "plaque dissolver" claims are not',
    summary:
      "Bacterial protease with narrow human evidence in post-surgical inflammation (Bhagat dental extraction), sinusitis symptom relief, and breast engorgement. The marketed cardiovascular / anti-atherosclerotic claims lack RCT support. PK is contentious; enteric coating is essential. Not a substitute for anticoagulation.",
    evidenceTier: 'C',
    relatedHallmarkIds: ['inflammation', 'communication'],
    compoundId: 'serrapeptase',
    outline: [
      'What serrapeptase does (and the PK caveat)',
      'Mechanism — fibrinolysis, bradykinin degradation',
      'Evidence (Bhagat dental, Mazzone ENT, Kee mastitis)',
      'Dosing — enteric coating between meals',
      'Monitoring',
      'Safety — bleeding risk, anticoagulant interaction',
      'Synergies and antagonists',
    ],
    mdxSlug: 'serrapeptase',
  },
  {
    slug: 'bromelain',
    category: 'compounds',
  ...
  },
  {
    ...
    category: 'compounds',
    title: 'Boron',
    tagline: 'Trace mineral with small but real effects on free testosterone, SHBG, and vitamin D half-life',
    summary:
      'Not classically essential but likely a beneficial minor. Naghii 2011 showed 6 mg/day reduced SHBG and raised free testosterone in males over 7 days; Nielsen 1987 showed calcium and estradiol effects in postmenopausal women. Extends vitamin D and magnesium retention. Cheap and well-tolerated.',
    evidenceTier: 'C',
    relatedHallmarkIds: ['communication', 'proteostasis'],
    compoundId: 'boron',
    outline: [
      'What boron does (and why it matters)',
      'Mechanism — SHBG, vitamin D half-life, bone matrix',
      'Evidence (Naghii, Nielsen, Newnham arthritis)',
      'Dosing (3-6 mg/day)',
      'Monitoring',
      'Safety',
      'Synergies and antagonists',
  ...
  },
  {
    ...
    tagline: 'Modest glycemic lever with a debated "essentiality" story',
    summary:
      "Trace element whose 'essential' status has been increasingly questioned. Suksomboon 2014 meta of 25 T2D RCTs found ~0.55% HbA1c reduction — statistically significant but clinically modest. Docherty 2005 showed carbohydrate-craving reduction in atypical depression. Cheap adjunct; not a driver.",
    evidenceTier: 'C',
    relatedHallmarkIds: ['nutrient'],
    compoundId: 'chromium',
    outline: [
      'What chromium does (and why the essentiality is debated)',
      'Mechanism — insulin signaling (contested), serotonergic',
      'Evidence (Suksomboon meta, Anderson, Docherty, Balk meta)',
      'Dosing (picolinate form)',
      'Monitoring',
      'Safety',
      'Synergies and antagonists',
    ],
  ...
  },
  {
    ...
    tagline: 'Ayurvedic adaptogen with modest anxiety and glycemic RCT evidence',
    summary:
      'Ocimum tenuiflorum leaf extract (distinct from culinary sweet basil). Saxena 2012 showed anxiety-score reduction in 158 GAD adults; Somasundaram 2018 showed fasting glucose and HbA1c reduction in T2D. Ursolic acid content is behind the preclinical muscle-preserving story. Traditional use includes anti-fertility — caution during conception.',
    evidenceTier: 'C',
    relatedHallmarkIds: ['communication', 'inflammation', 'nutrient'],
    compoundId: 'holy-basil',
    outline: [
      'What holy basil does (and why it matters)',
      'Mechanism — HPA, GABA, anti-inflammatory',
      'Evidence (Saxena, Somasundaram, Cohen review)',
      'Dosing — standardized to ursolic acid',
      'Monitoring',
      'Safety — fertility caution, mild thyroid effect',
      'Synergies and antagonists',
    ],
    mdxSlug: 'holy-basil',
  },
