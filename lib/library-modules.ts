...
export const libraryModules: LibraryModule[] = [
  ...
  },
  {
    ...
    category: 'compounds',
    title: 'Fisetin',
    tagline: 'Senolytic flavonoid — highest potency ranking; human trials underway',
    summary:
      'Flavonoid with the highest senolytic potency of dietary compounds tested (Kirkland lab, 2018) — clears senescent cells in mouse and human tissue and extends lifespan in mice. Human trials in older adults (AFFIRM, NCT03430037) are ongoing; outcomes not yet published. Pulse-dose protocol (20 mg/kg × 2 consecutive days/month) mirrors the trial design. Tier B pending completed human RCT.',
    evidenceTier: 'B',
    ...
    outline: [
      ...
      'Human trials — status (in progress)',
