...
const curatedCitations: SourceCitation[] = [
  ...
  },
  {
    ...
    pmid: '36482258',
    type: 'clinical',
    summary: 'Randomized, placebo-controlled dose-ranging NMN trial confirming safe NAD+ elevation in healthy middle-aged adults.',
  },
  {
    id: 'c-akg-2020',
  ...
  {
    id: 'c-sf-2008',
    title: 'Sulforaphane upregulates NRF2 and NQO1 in humans',
    authors: 'Ribeiro M et al.',
    journal: 'Free Radic Biol Med',
    year: 2024,
    pmid: '38772511',
    type: 'clinical',
    summary: 'Randomized human trial: sulforaphane (400 µg/day) raised NRF2 and NQO1 expression — direct evidence of NRF2 pathway activation in vivo.',
  },
  {
    id: 'c-resv-2006',
  ...
  },
  {
    ...
    pmid: '19587680',
    type: 'preclinical',
    summary: 'NIA-ITP landmark: rapamycin begun at 600 days extended median/maximal lifespan in mice. Off-label human use requires physician supervision.',
  },
  {
    id: 'c-fgf21-2026',
    title: 'AAV-FGF21 gene therapy promotes healthspan extension in aged mice',
    authors: 'Jimenez V et al.',
    journal: 'Mol Ther',
    year: 2026,
    pmid: '42231578',
    type: 'preclinical',
    summary: 'Muscle-targeted AAV-FGF21 delivery extended healthspan and lifespan with sustained organ benefits in aged mice.',
  },
  {
  ...
  },
  {
    ...
    pmid: '31542391',
    type: 'clinical',
    summary: 'First human senolytic trial: dasatinib + quercetin reduced senescent-cell burden in adipose tissue and skin of patients with diabetic kidney disease.',
  },
  {
    id: 'c-cakg-epi-2024',
    title: 'Ca-AKG (Rejuvant) associated with lower DNA-methylation age',
    authors: 'Demidenko O et al.',
    journal: 'Aging (Albany NY)',
    year: 2021,
    pmid: '34847066',
    type: 'clinical',
    summary: 'Open-label retrospective (n=42): ~8-year average DNA-methylation age reduction after ~7 months of Ca-AKG. Uncontrolled — no placebo arm; not yet replicated in an RCT.',
  },
  {
    id: 'c-sleep-epi-2024',
    title: 'Insomnia symptoms associated with epigenetic aging in women',
    authors: 'Carroll JE et al.',
    journal: 'Biol Psychiatry',
    year: 2016,
    pmid: '27702440',
    type: 'clinical',
    summary: 'Cross-sectional (Women’s Health Initiative, n=2,078): insomnia symptoms associated with accelerated epigenetic age and immune senescence. Association, not causation.',
  },
  {
    id: 'c-sfn-microbiome-2023',
    title: 'Sulforaphane activates the NRF2 antioxidant response in humans',
    authors: 'Ribeiro M et al.',
    journal: 'Free Radic Biol Med',
    year: 2024,
    pmid: '38772511',
    type: 'clinical',
    summary: 'Human RCT: sulforaphane upregulated NRF2/NQO1 expression. (No human trial supports a distinct gut-microbiome-reshaping claim, so evidence is scoped to NRF2 activation.)',
  },
  {
    id: 'c-resv-human-2024',
    title: 'Resveratrol activates SIRT1/AMPK in humans (calorie-restriction-like)',
    authors: 'Timmers S et al.',
    journal: 'Cell Metab',
    year: 2011,
    pmid: '22055504',
    type: 'clinical',
    summary: 'Placebo-controlled human crossover: 30 days of resveratrol activated SIRT1/AMPK and improved metabolic markers in obese men.',
  },
  {
    ...
    pmid: '25540326',
    type: 'clinical',
    summary: 'Randomized trial: low-dose mTOR inhibition (everolimus) enhanced vaccine response and immune function in older adults.',
  },
  {
  ...
  },
  {
    ...
    pmid: '30279143',
    type: 'preclinical',
    summary: 'Fisetin cleared senescent cells and extended health/lifespan in mice, and reduced senescence in human adipose explants. Human dosing trials are ongoing — not yet a completed human outcome trial.',
  },
];
