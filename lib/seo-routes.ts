...
export const seoRoutes = {
  ...
  contact: () =>
    buildPageMetadata({
      ...
      description: 'Structured channel for educational questions, platform issues, and partnership inquiries. Not a medical consultation.',
      path: '/contact',
    }),
  ...
  stacks: () =>
    buildPageMetadata({
      ...
      description:
        'Interactive stack builder: real-time synergy scoring, hallmark coverage map, contraindication checks, and seven preset protocols — Starter, NRF2 Defense, Mito-NAD+, Full Hybrid, Longevity Pro, Cardio-Metabolic, and Full-Spectrum.',
      path: '/stacks',
  ...
  trustSponsorship: () =>
    buildPageMetadata({
      title: 'Sponsorship & Advertising Principles — TNiC',
      description:
        'How TNiC separates sponsorship, affiliate links, editorial content, scientific analysis, evidence tiers, and user-entered data.',
