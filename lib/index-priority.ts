...
export const PRIORITY_INDEX_PATHS = [
  ...
  '/library/pathways/sirtuin-nad-axis',
  '/peptides',
  '/peptides/glp1-longevity',
  '/peptides/bpc-157',
  '/library/compare',
...
export const POPULAR_GUIDE_LINKS = [
  ...
  { href: '/library/pathways', label: 'Molecular Pathways' },
  { href: '/library/pathways/ampk-activation', label: 'AMPK Activation Pathway' },
  { href: '/library/pathways/sirtuin-nad-axis', label: 'Sirtuin / NAD+ Axis' },
