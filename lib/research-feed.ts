...
export const researchFeed = [
  ...
  {
    id: 'r4',
    title: 'NMN Raises Blood NAD+ Dose-Dependently — Peak Effect at 600 mg',
    source: 'GeroScience',
    date: 'Dec 2022',
    tag: 'NAD+ Restoration',
    summary: 'Yi et al. dose-ranging RCT in 80 healthy middle-aged adults: 300, 600 or 900 mg/day for 60 days raised blood NAD+ dose-dependently, with the largest effect at 600 mg — not at the highest dose tested.',
    pmid: '36482258',
    impact: 'clinical' as const,
