...
export const libraryModuleTitles: Record<string, string> = {
  ...
  'compounds/boron': 'Boron',
  'compounds/pqq': 'PQQ (Pyrroloquinoline Quinone)',
  'compounds/ashwagandha': 'Ashwagandha (KSM-66 / Withania somnifera)',
  'compounds/l-theanine': 'L-Theanine',
  'compounds/rhodiola': 'Rhodiola Rosea',
  'compounds/lions-mane': "Lion's Mane (Hericium erinaceus)",
  'compounds/bacopa': 'Bacopa Monnieri',
  'compounds/dhea': 'DHEA',
  'compounds/melatonin': 'Melatonin',
  'compounds/probiotics': 'Probiotics (Targeted, Strain-Specific)',
  'compounds/inositol': 'Inositol (Myo-Inositol)',
  'compounds/alpha-gpc': 'Alpha-GPC',
  'compounds/vitamin-b12': 'Vitamin B12 (Methylcobalamin)',
  'compounds/folate': 'Folate (5-MTHF)',
  'compounds/vitamin-c': 'Vitamin C (Ascorbic Acid)',
  'compounds/vitamin-e': 'Vitamin E (Mixed Tocopherols)',
  'compounds/iodine': 'Iodine',
  'compounds/chromium': 'Chromium Picolinate',
  'compounds/mct-oil': 'MCT Oil (Medium-Chain Triglycerides)',
  'compounds/beta-alanine': 'Beta-Alanine',
  'compounds/hmb': 'HMB (Beta-Hydroxy Beta-Methylbutyrate)',
  ...
  'synergies/berberine-resveratrol-ampk-sirt1': 'AMPK/SIRT1 Crosstalk Pair',
  'synergies/coq10-rala-redox-recycling': 'Redox Recycling Pair',
