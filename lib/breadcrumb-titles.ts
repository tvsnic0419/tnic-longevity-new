...
export const libraryModuleTitles: Record<string, string> = {
  ...
  'compounds/serrapeptase': "Serrapeptase (Serratiopeptidase)",
  ...
  'compounds/chromium': "Chromium (Chromium Picolinate)",
  'compounds/krill-oil': "Krill Oil (Phospholipid Omega-3)",
  'compounds/holy-basil': "Holy Basil (Tulsi, Ocimum sanctum)",
