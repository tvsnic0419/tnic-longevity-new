...
function getPageContextItems(pathname: string): PaletteItem[] {
  ...
  if (pathname.startsWith('/library')) {
    return [
      ...
      item('ctx-lib-quiz', 'Starter Questionnaire', { href: '/', kind: 'page' }),
  ...
  if (pathname === '/' || pathname === '') {
    return [
      item('ctx-home-quiz', 'Starter Questionnaire', { href: '/', kind: 'page' }),
  ...
  return [
    ...
    item('ctx-default-quiz', 'The NICO Starter Questionnaire', { href: '/', kind: 'page' }),
  ];
}
