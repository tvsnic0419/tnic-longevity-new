...
function getPageContextItems(pathname: string): PaletteItem[] {
  ...
  if (pathname.startsWith('/library')) {
    return [
      ...
      item('ctx-lib-quiz', '5-min stack quiz', { href: '/quiz', kind: 'page' }),
  ...
  if (pathname === '/' || pathname === '') {
    return [
      item('ctx-home-quiz', 'Take 5-min quiz', { href: '/quiz', kind: 'page' }),
  ...
  return [
    ...
    item('ctx-default-quiz', '5-Min Starter Quiz', { href: '/quiz', kind: 'page' }),
  ];
}
