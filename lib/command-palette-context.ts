...
function getPageContextItems(pathname: string): PaletteItem[] {
  ...
  if (pathname.startsWith('/library')) {
    return [
      ...
      item('ctx-lib-quiz', 'The Nico Starter Questionnaire', { href: '/quiz', kind: 'page' }),
  ...
  if (pathname === '/' || pathname === '') {
    return [
      item('ctx-home-quiz', 'Take The Nico Starter Questionnaire', { href: '/quiz', kind: 'page' }),
  ...
  return [
    ...
    item('ctx-default-quiz', 'The Nico Starter Questionnaire', { href: '/quiz', kind: 'page' }),
  ];
}
