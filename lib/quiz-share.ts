...
export function buildQuizShareMarkdown(answers: QuizAnswers): string {
  ...
  return `# TNiC NICO Starter Questionnaire Result — ${result.stack.label}
...
![${result.stack.label} questionnaire result](${buildQuizOgImageUrl(result.preset as PresetKey)})
