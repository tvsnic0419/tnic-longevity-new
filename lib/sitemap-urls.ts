...
export function buildSitemapEntries(lastModified = DEFAULT_SITEMAP_LAST_MODIFIED): MetadataRoute.Sitemap {
  ...
  const coreRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/urolithin-a-supplement-guide`, lastModified, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/fisetin-supplement-guide`, lastModified, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/coq10-supplement-guide`, lastModified, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/omega-3-supplement-guide`, lastModified, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/r-ala-supplement-guide`, lastModified, changeFrequency: 'weekly', priority: 0.84 },
    { url: `${base}/ca-akg-supplement-guide`, lastModified, changeFrequency: 'weekly', priority: 0.84 },
    { url: `${base}/resveratrol-supplement-guide`, lastModified, changeFrequency: 'weekly', priority: 0.84 },
    { url: `${base}/pterostilbene-supplement-guide`, lastModified, changeFrequency: 'weekly', priority: 0.84 },
