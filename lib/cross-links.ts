...
const COMPOUND_NAMES: Record<string, string[]> = {
  ...
  // The 35-compound library expansion (PR #107 upstream) — distinctive prose
  // forms only. Bare 3-letter acronyms that collide with common English words
  // are deliberately omitted ("PEA" → "pea", "SOD" → "sod"); every other
  // compound gets its full name plus any well-known, unambiguous short form.
  ...
  'panax-ginseng': ['Panax Ginseng', 'Korean Ginseng'],
  'mucuna-pruriens': ['Mucuna Pruriens'],
  theobromine: ['Theobromine'],
  capsaicin: ['Capsaicin'],
  'pumpkin-seed-oil': ['Pumpkin Seed Oil'],
  'superoxide-dismutase': ['Superoxide Dismutase', 'GliSODin'],
  piperine: ['Piperine', 'BioPerine'],
  'mct-oil': ['MCT Oil', 'Medium-Chain Triglycerides'],
  'bacopa-monnieri': ['Bacopa Monnieri', 'Bacopa'],
  cordyceps: ['Cordyceps'],
  ...
  chondroitin: ['Chondroitin Sulfate', 'Chondroitin'],
  'uc-ii': ['UC-II'],
  bromelain: ['Bromelain'],
  methylfolate: ['Methylfolate', 'L-Methylfolate', '5-MTHF'],
  methylcobalamin: ['Methylcobalamin'],
  p5p: ['Pyridoxal-5-Phosphate', 'P5P'],
