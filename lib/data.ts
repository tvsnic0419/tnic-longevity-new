...
export const compounds: Compound[] = [
  {
    ...
    studies: [
      { title: 'GlyNAC supplementation improves glutathione deficiency in aging humans', journal: 'Clin Transl Med', year: 2021, pmid: '33783984' },
  ...
  },
  {
    ...
    desc: 'NRF2 induction confirmed in human airway and CKD trials (PMIDs: 38772511, 27356680). The 2024 CKD RCT showed NQO1 mRNA doubling and significant inflammatory marker reduction with sulforaphane supplementation. Optimal source: fresh broccoli sprouts or standardized glucoraphanin extract with myrosinase; avoid boiling sprouts as heat destroys myrosinase. Bioavailability peaks 1–2 hours post-ingestion.',
    badge: 'nrf2',
    bioavailability: 78,
    evidence: 'A',
  ...
  },
  {
    ...
    desc: 'Fisetin is the most potent senolytic flavonoid tested in vitro, and in mice it cleared senescent cells and extended health and lifespan, with senescence reduction confirmed in human adipose-tissue explants (Kirkland/Yousefzadeh group, EBioMedicine 2018, PMID 30279143). Human senolytic trials in older adults are underway (NCT03675724, NCT04733534) but outcome results are not yet published. Tier B reflects strong preclinical and human-tissue data pending completed human outcome trials — mouse lifespan data is not presented here as human evidence.',
    badge: 'longevity',
    bioavailability: 40,
    evidence: 'B',
