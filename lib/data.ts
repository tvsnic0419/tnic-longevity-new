...
export const glossary = [
  ...
  { term: 'Hallmarks of Aging', simple: 'The 12 biological processes that drive aging — from mitochondrial decline to chronic inflammation.', why: 'Every compound is mapped to specific hallmarks so you know exactly what each supplement targets.' },
  ...
  { term: 'Synergy', simple: 'When two compounds together produce greater effect than either alone.', why: 'The synergy score measures this — random stacking wastes money and can cause interactions.' },
  ...
  { term: 'Healthspan', simple: 'The portion of life spent in good health, free from chronic disease or disability — distinct from lifespan (total years alive).', why: 'The focus here is healthspan, not maximum lifespan. The target is more quality years in your 60s, 70s, and beyond — not just extending decline.' },
  { term: 'Autophagy', simple: 'The cellular self-cleaning process that breaks down and recycles damaged proteins, organelles, and pathogens.', why: 'Autophagy declines with age, allowing cellular debris to accumulate. It is activated by fasting, exercise, rapamycin, and resveratrol — which is why fasted morning dosing of resveratrol is recommended in the protocol.' },
...
export const consumerFAQ = [
  ...
  },
  {
    ...
    answer: 'No supplement protocol is universal. Pregnant/nursing individuals, people under 18, those on chemotherapy, blood thinners, or with kidney/liver disease must consult a physician first. Per-compound safety data lives in the Trust Center — use it before starting anything.',
  },
  {
    id: 'faq3',
  ...
  },
  {
    ...
    answer: 'No. TNiC is an independent intelligence platform. We curate third-party products that meet our evidence and bioavailability standards. Picks link to manufacturer sites and may include an affiliate token — This site may earn a commission on purchases at no extra cost to you. Commission never influences which products are listed or their evidence tier.',
  },
  {
    id: 'faq5',
    category: 'science' as const,
  ...
  },
  {
    ...
    answer: 'NRF2 is a transcription factor that switches on 200+ cytoprotective genes when activated. Three compounds here target it: sulforaphane activates it via KEAP1 modification, GlyNAC supplies glutathione precursors it upregulates, and R-ALA recycles oxidized products. Together they form the NRF2 Defense Triad.',
  },
  {
    id: 'faq15',
    category: 'products',
  ...
  },
  {
    ...
    answer: 'Epigenetic clocks measure DNA methylation patterns to calculate biological age. TruDiagnostic ($300-500) offers the most comprehensive consumer panel including DunedinPACE. The biological age estimate is a lifestyle model — useful for directional feedback before a lab test.',
  },
  {
    id: 'faq19',
    category: 'safety',
  ...
  },
  {
    ...
    answer: 'Metformin is a biguanide prescription drug — not a supplement. Though the TAME trial (Targeting Aging with Metformin) is underway, evidence for longevity outcomes in non-diabetic adults remains incomplete. Metformin also blocks the muscle hypertrophy response to exercise via AMPK interference — a significant tradeoff. This library provides overlapping AMPK-supportive mechanisms (Ca-AKG, R-ALA, NMN) without the prescription risk.',
  },
  {
    id: 'faq29',
    category: 'science' as const,
