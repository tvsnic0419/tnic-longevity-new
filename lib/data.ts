...
export const researchFeed = [
  ...
  {
    id: 'r18',
    title: 'Fisetin Is the Most Potent Senolytic Flavonoid — Extends Lifespan in Mice',
    source: 'EBioMedicine',
    date: 'Oct 2018',
    tag: 'Senolytics',
    summary: 'Yousefzadeh et al. screened 10 flavonoids and found fisetin the most potent senolytic — clearing senescent cells in mouse and human tissue and extending health- and lifespan in aged mice. Human outcome data are not yet published; clinical trials (AFFIRM, NCT03430037) are ongoing.',
    pmid: '30279143',
    impact: 'preclinical' as const,
    relatedHrefs: [
  ...
  {
    id: 'r27',
    title: 'Fisetin Clears Senescent Cells in Human Tissue and Extends Mouse Lifespan',
    source: 'EBioMedicine',
    date: 'Oct 2018',
    tag: 'Senolytics',
    summary: 'The senolytic screen behind fisetin (PMID 30279143): fisetin selectively cleared senescent cells in human tissue explants and, given intermittently to aged mice, reduced senescence markers and extended health- and lifespan. This is preclinical + human-tissue evidence — human clinical outcomes remain unpublished (trials such as AFFIRM, NCT03430037, are ongoing).',
    pmid: '30279143',
    impact: 'preclinical' as const,
    relatedHrefs: [
      { label: 'Cellular Senescence', href: '/library/cellular-senescence' },
...
export const hallmarks: Hallmark[] = [
  ...
  { id: 'senescence', title: 'Cellular Senescence', desc: 'Zombie cells secrete SASP inflammatory factors', coverage: 75, icon: Heart, intervention: 'Quercetin + Dasatinib cleared senescent cells in human adipose tissue (PMID 31542391). NMN reduces SASP via NAD+-dependent PARP and SIRT1. Fisetin cleared senescent cells and extended healthspan in mice and human tissue (PMID 30279143); human trials ongoing.' },
