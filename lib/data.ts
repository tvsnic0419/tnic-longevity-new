...
export const compounds: Compound[] = [
  {
    ...
    desc: 'Two independent RCTs (Sekhar group, Baylor) confirm GlyNAC supplementation (16–24 weeks) restores GSH levels to those of young adults, reduces oxidative stress markers, improves mitochondrial function, and reduces inflammatory cytokines across multiple hallmarks in older adults (PMIDs: 33783984, 35975308). The 2023 JGBA trial is the most comprehensive aging-reversal human RCT yet published for a single compound pair.',
    badge: 'nrf2',
    bioavailability: 92,
    evidence: 'A',
    ...
    studies: [
      { title: 'Glycine and N-acetylcysteine (GlyNAC) supplementation in older adults improves glutathione deficiency, oxidative stress, mitochondrial dysfunction, inflammation, and physical function: A pilot clinical trial', journal: 'Clin Transl Med', year: 2021, pmid: '33783984' },
  ...
  },
  {
    ...
    studies: [
      { title: 'Oral sulforaphane increases Phase II antioxidant enzymes in the human upper airway', journal: 'Clin Immunol', year: 2009, pmid: '19028145' },
  ...
  },
  {
    ...
    studies: [
      { title: 'Mitochondrial ageing and the beneficial role of alpha-lipoic acid', journal: 'Neurochem Res', year: 2007, pmid: '17476591' },
    ],
  },
  {
    id: 'cakg',
    ...
    desc: 'Ca-AKG extended median lifespan 12–14% in mice by supplementing TCA cycle flux and dioxygenase (TET/JMJD) cofactor supply (Cell Metab 2020, PMID 32877690). Also supports collagen synthesis (prolyl hydroxylase cofactor), relevant for connective tissue integrity. The ABLE trial, a registered human RCT testing whether Ca-AKG slows epigenetic aging, has a published protocol (GeroScience 2023) but results are not yet available — human efficacy for biological-age reduction is not yet established. Timing: AM fasted, as high protein meals compete for AKG absorption by providing competing carbon sources.',
    badge: 'mito',
    bioavailability: 88,
    evidence: 'B',
    dose: '1–2g Ca-AKG',
  ...
  },
  {
    ...
    desc: 'NAD+ declines ∼50% between ages 40–60 across multiple tissues. Human RCTs confirm NMN supplementation raises whole-blood NAD+ (GeroScience 2022, PMID 36482258) and improves skeletal muscle insulin sensitivity in prediabetic women (Science 2021, PMID 33888596). The SIRT1/PARP/SIRT3 triad that NAD+ fuels spans DNA repair (PARP), epigenetic maintenance (SIRT1), mitochondrial efficiency (SIRT3), and autophagy regulation (SIRT1→ATG deacetylation) — making NAD+ restoration the highest-leverage single target in longevity biochemistry.',
    badge: 'mito',
    bioavailability: 90,
    evidence: 'A',
    dose: '250–500mg NMN',
  ...
  },
  {
    ...
    desc: 'Baur et al. 2006 (Nature, PMID 17086191) showed resveratrol improved health and survival in mice on a high-calorie diet via SIRT1 activation — the foundational study behind resveratrol\'s longevity interest. The NMN + resveratrol stack has strong mechanistic rationale: NMN raises the NAD+ substrate, resveratrol increases SIRT1 catalytic affinity for it — together they may restore sirtuin output more than either alone, though this specific combination hasn\'t been tested in a dedicated human RCT. PM timing is preferred (circadian SIRT1 expression peaks in the evening). Take with a fat-containing meal to improve absorption.',
    badge: 'mito',
    bioavailability: 72,
    evidence: 'B',
  ...
  },
  {
    ...
    desc: 'Madeo et al. 2018 (Science, PMID 29371440) reviews spermidine\'s autophagy-inducing mechanism and its association with reduced all-cause mortality in dietary-intake cohort studies. Mouse studies show dietary spermidine improves cognitive function, but the largest human RCT to date testing spermidine for memory in older adults did not find a statistically significant benefit versus placebo — human evidence for the memory claim specifically remains unproven despite the strong preclinical autophagy case. Tier B — mechanistically compelling, epidemiology supportive; the flagship human cognitive-outcome trial was null.',
    badge: 'mito',
    bioavailability: 65,
    evidence: 'B',
  ...
  },
  {
    ...
    desc: 'Riche et al. 2013 (J Toxicol, PMID 23431291) conducted a human dose-escalation safety trial of pterostilbene up to 250 mg/day over 6–8 weeks, establishing a human safety profile. Preclinical data supports pterostilbene\'s higher bioavailability versus resveratrol (methoxy groups reduce first-pass glucuronidation), cognitive benefits via BDNF upregulation, and SIRT1-mediated epigenetic maintenance. Human longevity endpoint trials not yet completed. Tier B — human safety established at up to 250mg/day; bioavailability advantage over resveratrol is mechanistically well-supported.',
    badge: 'mito',
    bioavailability: 82,
    evidence: 'B',
    ...
    studies: [
      { title: 'Analysis of Safety from a Human Clinical Trial with Pterostilbene', journal: 'J Toxicol', year: 2013, pmid: '23431291' },
    ],
  },
  {
    id: 'berberine',
    ...
    desc: 'Head-to-head RCT (Yin 2008, Metabolism, PMID 18442638) showed berberine 500 mg TID reduced fasting glucose 20% and HbA1c by 2.0 percentage points — outcomes statistically equivalent to metformin. A 2018 meta-analysis of 16 RCTs (Ju et al., Phytomedicine, PMID 30466986) confirmed berberine improves lipid profiles (LDL, triglycerides) in dyslipidemia. Also activates AMPK with metabolic effects comparable to metformin (Lee et al. 2006, Diabetes, PMID 16873688) and reduces inflammatory markers in multiple trials. Standard bioavailability ~36%; dihydroberberine or BPEL formulations achieve 5× higher plasma levels. Tier A for metabolic endpoints; Tier B for direct longevity outcomes.',
    badge: 'mito',
    bioavailability: 36,
    evidence: 'A',
    ...
    studies: [
      ...
      { title: 'Berberine, a natural plant product, activates AMP-activated protein kinase with beneficial metabolic effects in diabetic and insulin-resistant states', journal: 'Diabetes', year: 2006, pmid: '16873688' },
      { title: 'Efficacy and safety of berberine for dyslipidaemias: A systematic review and meta-analysis of randomized clinical trials', journal: 'Phytomedicine', year: 2018, pmid: '30466986' },
    ],
  },
  {
    id: 'urolithina',
    ...
    desc: 'First human clinical evidence that an oral compound can stimulate mitophagy in skeletal muscle of older adults (Nature Metabolism 2019, PMID 32694802). A randomized trial (Cell Reports Medicine 2022) in middle-aged adults confirmed urolithin A improved muscle strength, exercise performance, and biomarkers of mitochondrial health versus placebo (PMID 35584623). Two Tier A studies now support clinical use for mitochondrial aging and muscle quality.',
    badge: 'mito',
    bioavailability: 45,
    evidence: 'A',
    ...
    studies: [
      { title: 'The mitophagy activator urolithin A is safe and induces a molecular signature of improved mitochondrial and cellular health in humans', journal: 'Nature Metabolism', year: 2019, pmid: '32694802' },
      { title: 'Urolithin A improves muscle strength, exercise performance, and biomarkers of mitochondrial health in a randomized trial in middle-aged adults', journal: 'Cell Reports Medicine', year: 2022, pmid: '35584623' },
  ...
  },
  {
    ...
    desc: 'Fisetin was identified as the most potent senolytic among 10 flavonoids tested, selectively eliminating senescent cells via BCL-2/BCL-XL inhibition; in mice, both acute and intermittent treatment reduced senescence markers across tissues and extended median and maximum lifespan (Yousefzadeh et al. 2018, EBioMedicine, PMID 30279143). Mayo Clinic\'s published human senolytic pilot trials to date have used a dasatinib+quercetin combination rather than fisetin alone; dedicated fisetin-specific human trials for age-related conditions are registered (e.g. NCT03675724, NCT04733534) but results were not confirmed as of this writing. Tier B — outstanding preclinical/mouse senolytic data; human evidence specific to fisetin alone is still emerging.',
    badge: 'longevity',
    bioavailability: 40,
    evidence: 'B',
  ...
  },
  {
    ...
    desc: 'Endogenous CoQ10 biosynthesis peaks at age 20–30 and declines ~50% by age 60. Statins (HMG-CoA reductase inhibitors) block the same mevalonate pathway that produces CoQ10, and a controlled study found statin therapy reduced muscle CoQ10 content and mitochondrial OXPHOS capacity (J Am Coll Cardiol 2013, PMID 23287371). Ubiquinol form achieves higher plasma concentrations vs conventional ubiquinone in clinical trials. A 2017 meta-analysis of RCTs (Fan et al., Pharmacol Res, PMID 28179205) confirmed significant hs-CRP and IL-6 reduction with CoQ10 supplementation. Additional meta-analyses confirm reduced heart failure mortality and improved exercise tolerance. Tier B for longevity; Tier A for statin-induced deficiency correction and heart failure outcomes.',
    badge: 'mito',
    bioavailability: 58,
    evidence: 'B',
    ...
    hallmarks: ['mito', 'inflammation', 'genomic'],
    studies: [
      { title: 'Effects of coenzyme Q10 supplementation on inflammatory markers: A systematic review and meta-analysis of randomized controlled trials', journal: 'Pharmacol Res', year: 2017, pmid: '28179205' },
      { title: 'Coenzyme Q10 Supplementation in Aging and Disease', journal: 'Front Physiol', year: 2018, pmid: '29459830' },
      { title: 'Simvastatin Effects on Skeletal Muscle: Relation to Decreased Mitochondrial Function and Glucose Intolerance', journal: 'J Am Coll Cardiol', year: 2013, pmid: '23287371' },
    ],
  },
  {
    id: 'omega3',
    ...
    desc: 'The most extensively studied anti-inflammatory supplement in medicine with over 30,000 published studies. REDUCE-IT trial (2019, NEJM, PMID 30415628): 4g/day icosapent ethyl (EPA-only) reduced major cardiovascular events by 25% in high-risk patients versus mineral oil placebo — the largest cardiovascular benefit ever demonstrated for a supplement. A randomized controlled trial also found omega-3 supplementation reduced oxidative stress and preserved leukocyte telomere length versus placebo in healthy adults (Brain Behav Immun 2013, PMID 23010452). Triglyceride (re-esterified) form achieves superior absorption vs ethyl ester form. Tier A evidence for cardiovascular inflammation and telomere preservation; Tier B for direct longevity endpoints.',
    badge: 'nrf2',
    bioavailability: 73,
    evidence: 'A',
    ...
    studies: [
      { title: 'Cardiovascular Risk Reduction with Icosapent Ethyl for Hypertriglyceridemia', journal: 'N Engl J Med', year: 2019, pmid: '30415628' },
      { title: 'Omega-3 fatty acids, oxidative stress, and leukocyte telomere length: A randomized controlled trial', journal: 'Brain Behav Immun', year: 2013, pmid: '23010452' },
    ],
  },
];
...
export const biomarkers = [
  ...
  },
  {
    ...
    optimal: '15–25',
    critical: '<10',
    desc: 'TCA cycle intermediate that falls with age and correlates strongly with DNA methylation-based epigenetic clocks. A human RCT testing whether Ca-AKG supplementation reduces biological age (the ABLE trial) is registered with a published protocol, but results are not yet available.',
    compounds: ['cakg'],
  },
  {
    id: '8ohdg',
...
export const researchFeed = [
  ...
  {
    id: 'r2',
    title: 'GlyNAC Pilot Trial Restores Glutathione and Mitochondrial Function in Older Adults',
    source: 'Clinical and Translational Medicine',
    date: 'Jan 2021',
    tag: 'NRF2 / Glutathione',
    summary: 'Pilot clinical trial found GlyNAC supplementation in older adults restored glutathione deficiency, reduced oxidative stress, improved mitochondrial dysfunction and inflammation, and improved physical function markers.',
    pmid: '33783984',
  ...
  {
    id: 'r3',
    title: 'Alpha-Ketoglutarate, an Endogenous Metabolite, Extends Lifespan in Aging Mice',
    source: 'Cell Metabolism',
    date: 'Sep 2020',
    tag: 'Mitochondria',
    summary: 'Ca-AKG supplementation extended median lifespan 12–14% in mice and compressed morbidity by modulating TCA cycle flux and epigenetic (TET/JMJD) cofactor supply. Preclinical — human epigenetic-age effects have not yet been established.',
    pmid: '32877690',
  ...
  {
    id: 'r18',
    title: 'Fisetin Is the Most Potent Senolytic Flavonoid Tested in Mice',
    source: 'EBioMedicine',
    date: 'Sep 2018',
    tag: 'Senolytics',
    summary: 'Screening of 10 flavonoids identified fisetin as the most potent senolytic, selectively eliminating senescent cells and extending median and maximum lifespan in mice. Human trials testing fisetin alone (as opposed to the dasatinib+quercetin combination used in Mayo Clinic pilots) are registered but not yet reported.',
    pmid: '30279143',
    impact: 'clinical' as const,
    relatedHrefs: [
  ...
  },
  {
    ...
    date: 'Jul 2019',
    tag: 'Mitophagy',
    summary: 'Randomized placebo-controlled trial in older adults showed that oral urolithin A (a gut-microbiome metabolite of pomegranate ellagitannins) is safe and induces a molecular signature of improved mitochondrial and cellular health. This is the first human clinical evidence that a gut-derived compound can stimulate mitophagy-associated gene expression in aging adults.',
    pmid: '32694802',
    impact: 'clinical' as const,
    relatedHrefs: [
      { label: 'Mitochondrial Dysfunction', href: '/library/mitochondrial-dysfunction' },
  ...
  {
    id: 'r21',
    title: 'Spermidine Review: Autophagy Induction and Mortality Association',
    source: 'Science',
    date: 'Jan 2018',
    tag: 'Autophagy',
    summary: 'Review of spermidine\'s autophagy-inducing mechanism and its association with reduced all-cause mortality in dietary-intake cohort studies. Mouse studies show dietary spermidine improves cognitive function, but the largest human RCT testing spermidine for memory in older adults did not find a statistically significant benefit versus placebo — the memory claim specifically remains unproven in humans despite the strong preclinical autophagy case.',
    pmid: '29371440',
    impact: 'clinical' as const,
    relatedHrefs: [
      { label: 'Disabled Autophagy', href: '/library/disabled-autophagy' },
  ...
  },
  {
    ...
    date: 'May 2008',
    tag: 'AMPK / mTOR',
    summary: 'Randomized clinical trial showed berberine (500 mg three times daily) reduced fasting blood glucose by 20% and HbA1c by 2.0 percentage points in patients with type 2 diabetes — outcomes statistically equivalent to metformin. Berberine also activates AMPK, the cellular energy sensor that also inhibits mTOR, mimicking some effects of caloric restriction and placing it in the AMPK/longevity pathway alongside metformin and resveratrol.',
    pmid: '18442638',
    impact: 'clinical' as const,
    relatedHrefs: [
      { label: 'Deregulated Nutrient Sensing', href: '/library/nutrient-sensing' },
      { label: 'Mitochondrial preset', href: '/stacks?preset=mito' },
      { label: 'Protocol Brief digest', href: '/brief' },
    ],
  },
  {
    id: 'r23',
    title: 'Randomized Trial: Urolithin A Improves Muscle Strength and Exercise Performance in Middle-Aged Adults',
    source: 'Cell Reports Medicine',
    date: 'Apr 2022',
    tag: 'Mitophagy',
    summary: 'Randomized trial in middle-aged adults found urolithin A supplementation improved muscle strength, exercise performance, and biomarkers of mitochondrial health versus placebo. Builds on the 2019 first-in-human mitophagy signature study to show functional muscle benefits.',
    pmid: '35584623',
    impact: 'clinical' as const,
    relatedHrefs: [
      { label: 'Mitochondrial Dysfunction', href: '/library/mitochondrial-dysfunction' },
  ...
  },
  {
    ...
    summary: 'The REDUCE-IT trial showed icosapent ethyl (a purified EPA formulation, 4g/day) reduced major adverse cardiovascular events by 25% relative risk versus mineral-oil placebo in patients with elevated triglycerides on statin therapy — the largest cardiovascular benefit demonstrated for a supplement-derived agent to date.',
    pmid: '30415628',
    impact: 'breakthrough' as const,
    relatedHrefs: [
      { label: 'Chronic Inflammation', href: '/library/chronic-inflammation' },
  ...
  {
    id: 'r25',
    title: 'Meta-Analysis: CoQ10 Supplementation Reduces Inflammatory Markers',
    source: 'Pharmacological Research',
    date: 'Jan 2017',
    tag: 'Mitochondria',
    summary: 'Meta-analysis of randomized controlled trials found CoQ10 supplementation significantly reduced hs-CRP and IL-6 compared to placebo. CoQ10 biosynthesis declines with aging and is further suppressed by statin use, identifying supplementation as a targeted intervention for statin-associated deficiency and inflammaging.',
    pmid: '28179205',
    impact: 'clinical' as const,
    relatedHrefs: [
      { label: 'Mitochondrial Dysfunction', href: '/library/mitochondrial-dysfunction' },
...
export const hallmarks: Hallmark[] = [
  { id: 'genomic', title: 'Genomic Instability', desc: 'Accumulated DNA damage overwhelms repair machinery', coverage: 85, icon: Dna, intervention: 'NMN replenishes NAD+ consumed by PARP during strand repair. Sulforaphane activates NQO1 and phase-II detox enzymes that shield DNA from oxidative adducts.' },
  ...
  { id: 'epigenetic', title: 'Epigenetic Alterations', desc: 'Drift in methylation & histone marks alters gene expression', coverage: 78, icon: Layers, intervention: 'Ca-AKG fuels TET dioxygenase demethylation — a human RCT testing its effect on epigenetic age (the ABLE trial) is registered but not yet reported. NMN restores NAD+ for SIRT1/SIRT3 histone deacetylation.' },
  ...
  { id: 'autophagy', title: 'Disabled Autophagy', desc: 'Cellular cleanup machinery slows with age', coverage: 70, icon: Scale, intervention: 'NMN activates SIRT1-mediated autophagy initiation. Spermidine (polyamine) directly triggers autophagic flux via EP300 inhibition — the largest human RCT testing spermidine for cognitive benefit did not reach statistical significance, though the autophagy mechanism itself is well established. Sulforaphane NRF2 supports autophagosome clearance.' },
  ...
  { id: 'senescence', title: 'Cellular Senescence', desc: 'Zombie cells secrete SASP inflammatory factors', coverage: 75, icon: Heart, intervention: 'Quercetin + Dasatinib cleared senescent cells in human adipose tissue (PMID 32854868). NMN reduces SASP via NAD+-dependent PARP and SIRT1. Fisetin is the most potent senolytic among flavonoids tested in mice; human trials specific to fisetin (as opposed to the dasatinib+quercetin combination) are still emerging.' },
  ...
  { id: 'dysbiosis', title: 'Dysbiosis', desc: 'Gut microbiome imbalance affects systemic aging', coverage: 40, icon: Radio, intervention: 'Sulforaphane and its breakdown products are believed to favorably shift gut flora composition, though the human evidence for this specific effect needs a fuller citation review. Taurine also modulates gut barrier integrity and bile acid composition.' },
  { id: 'nutrient', title: 'Deregulated Nutrient Sensing', desc: 'Nutrient sensing pathways (mTOR/AMPK) dysregulate', coverage: 72, icon: Shield, intervention: 'Resveratrol activates AMPK to inhibit mTORC1 and restore autophagic signaling. Berberine activates AMPK with metabolic effects comparable to metformin (PMID 18442638). NMN supports SIRT1-mTOR axis balance via NAD+.' },
];
...
export const outcomeMilestones = [
  ...
  },
  {
    ...
    expectations: ['GlyNAC trials showed significant glutathione restoration at 24 weeks — early lab shifts possible at 12', 'Energy and exercise recovery often noticeably improved', 'Inflammation markers (hs-CRP) may trend downward', 'Ca-AKG mouse data shows TCA-cycle and epigenetic dioxygenase support; the human ABLE trial testing epigenetic-age effects has not yet reported results'],
    realistic: true,
  },
  {
    week: 'Week 24+',
    ...
    expectations: [
      ...
      'Ca-AKG: mouse lifespan/epigenetic data is strong (PMID 32877690); the human ABLE trial testing epigenetic-age effects is registered but has not yet reported results',
...
export const glossary = [
  ...
  { term: 'Epigenetic Clock', simple: 'A lab test measuring DNA methylation patterns across thousands of sites to calculate your true cellular age.', why: 'Epigenetic clocks (Horvath, GrimAge, DunedinPACE) are the most accurate biological age measurement available to consumers. Ca-AKG extended lifespan and compressed morbidity in mouse studies (PMID: 32877690); a human epigenetic-age trial (the ABLE study) has a published protocol but no reported results yet, so no human clock-reversal figure is claimed here.' },
...
export const consumerFAQ = [
  ...
  },
  {
    ...
    answer: 'Short sleep duration has been associated with faster epigenetic aging in observational cohort research, though the exact magnitude varies by study and population. Sleep is when SIRT1 and PARP peak, mitophagy clears damaged mitochondria, and the glymphatic system flushes amyloid. Treat sleep as non-negotiable.',
  },
  {
    id: 'faq20',
    category: 'products',
  ...
  },
  {
    ...
    answer: 'Animal studies of Ca-AKG have not identified serious toxicity at supplemental doses (PMID: 32877690). The ABLE human trial protocol is registered but has not yet reported adverse-event data. Anecdotally, the most common issue is mild transient GI discomfort in the first 1-2 weeks. Requires monitoring in kidney disease. Start at 500mg and titrate up over 2 weeks to minimize adjustment.',
  },
  {
    id: 'faq25',
    category: 'products',
