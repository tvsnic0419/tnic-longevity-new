...
export const evidenceComparisons: EvidenceComparison[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      {
        dimension: 'Questionnaire preset mapping',
    ...
    whenChooseA: [
      ...
      'Questionnaire result: inflammation or defense focus',
      'Age 55+ with oxidative lifestyle',
    ],
    whenChooseB: [
      'NAD+ below 80 or morning energy ≤5/10',
      'Questionnaire result: energy / mitochondrial focus',
  ...
  },
  {
    ...
    verdict:
      'Starter Elite wins for first-time stackers and questionnaire onboarding. Full Hybrid wins when baseline labs justify dual-pathway spend and compliance is proven at 12 weeks.',
    rows: [
      {
        dimension: 'Compounds',
        a: '3',
